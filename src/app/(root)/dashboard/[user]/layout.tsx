...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-[#0A0A0A]">
      <aside className="w-72 h-full bg-white dark:bg-[#0A0A0A] text-black dark:text-white p-6 flex flex-col gap-4 shadow-xl rounded-r-2xl border-r border-gray-200 dark:border-zinc-800 transition-colors duration-300">
        <div className="mb-4">
      ...
      <main className="flex-1 p-10 bg-white dark:bg-[#0A0A0A] transition-colors duration-300">
        {children}
      </main>
    </div>
  );
